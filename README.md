...
| Set / cooldown counter per exercise | The set screen, pushed from a Today row. At its foot: the last three times you did this exercise, and **its trend** — the same line the Trends tab draws, moving as you log. |
