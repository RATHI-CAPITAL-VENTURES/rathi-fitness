...
| Glasses | **Meta Ray-Ban Display.** Settings → Glasses. While a set screen is open on the phone the lens shows the same thing — what to lift, then the rest counting down, ember cooling to teal — and a pinch on the wristband logs the set or skips the rest. It **mirrors** the phone: pick the exercise here, then put the phone away. Taking the glasses off drops their connection and putting them back restores it in a few seconds; the phone keeps the workout either way. Needs Developer Mode in the Meta AI app, and is off until you switch it on — while it is off the app never calls Meta's code at all. See `docs/DECISIONS.md`, 2026-09-21. |
