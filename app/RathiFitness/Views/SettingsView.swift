    ...
    @ViewBuilder private var glassesSection: some View {
        SettingsSection(
            ...
            footer: "Meta Ray-Ban Display. While a set screen is open on the phone, the lens "
                  ...
                  + "This switch is its own: a pinch logs the set whether or not the AirPods' "
                  + "hands-free is on, because a button you can see and aim at is not the "
                  + "accident a squeeze through a hoodie can be.\n\n"
